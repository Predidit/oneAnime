...
class opencc {
  ...
  opencc(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;
  ...
  ffi.Pointer<ffi.Char> TranS2TW(
    ffi.Pointer<ffi.Char> _in,
  ) {
    return _TranS2TW(
      _in,
    );
  ...
  late final _TranS2TWPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>>('TranS2TW');
  late final _TranS2TW = _TranS2TWPtr.asFunction<
      ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>();

  ffi.Pointer<ffi.Char> TranTW2S(
    ffi.Pointer<ffi.Char> _in,
  ) {
    return _TranTW2S(
      _in,
  ...
  late final _TranTW2SPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>>('TranTW2S');
  late final _TranTW2S = _TranTW2SPtr.asFunction<
      ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>();
